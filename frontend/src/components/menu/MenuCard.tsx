    ...
    >
      <div className="flex-1 flex flex-col justify-between pr-4">
        ...
        <div className="flex items-center gap-3 mt-4">
          ...
          {item.is_featured && (
            <span className="bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 text-[10px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wider">Destacado</span>
          )}
